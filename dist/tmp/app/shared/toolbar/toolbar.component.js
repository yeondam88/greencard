...
var ToolbarComponent = (function () {
    ...
    ToolbarComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'toolbar',
            template: "<div class=\"topbar\">     <div class=\"container\" style=\"margin-bottom:9px;\">         <div class=\"row\">             <div class=\"col-sm-6\">                 <social></social>             </div>             <div class=\"col-sm-6\">                 <user></user>                 <languages></languages>             </div>         </div>     </div> </div>",
            styles: [""],
