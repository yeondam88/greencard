...
gulp.task('build.dev', function (done) {
    return runSequence('build.assets.dev', 'build.fonts', 'build.html_css', 'build.js.dev', 'build.index.dev', done);
});
...
gulp.task('build.prod', function (done) {
    return runSequence('clean.prod', 'build.assets.prod', 'build.fonts', 'build.html_css', 'copy.js.prod', 'build.js.prod', 'build.bundles', 'build.bundles.app', 'build.index.prod', done);
});
gulp.task('build.test', function (done) {
    return runSequence('clean.once', 'tslint', 'build.assets.dev', 'build.fonts', 'build.html_css', 'build.js.dev', 'build.js.test', 'build.index.dev', done);
});
